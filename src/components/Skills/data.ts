...
export const skills: SkillProps[] = [
    ...
    { name: 'Redux', level: 7, category: SkillCategories.Frameworks },
    ...
    { name: 'GraphQL', level: 9, category: SkillCategories.Frameworks },
    ...
    { name: 'PostgreSQL', level: 6, category: SkillCategories.Cloud },
]
